---
title: java并发--深入分析 ThreadLocal 内存泄漏问题
tags: [java, java并发 ,ThreadLocal, 内存泄漏]
...
*   使用`static`的`ThreadLocal`，延长了`ThreadLocal`的生命周期，可能导致的内存泄漏（参考[ThreadLocal 内存泄露的实例分析](https://blog.xiaohansong.com/ThreadLocal-leak-analyze.html)）。
...
```
 ...
 - [ThreadLocal出现OOM内存溢出的场景](https://blog.csdn.net/GoGleTech/article/details/78318712)
 - [使用ThreadLocal不当可能会导致内存泄露](https://blog.csdn.net/zhailuxu/article/details/79067467) 
...
# 参考文章
- 转自：[深入分析 ThreadLocal 内存泄漏问题](https://blog.xiaohansong.com/ThreadLocal-memory-leak.html)
- [ThreadLocal可能引起的内存泄露](http://www.cnblogs.com/onlywujun/p/3524675.html)




[1]: ./images/1553224734020.jpg "1553224734020.jpg"